# Based on: https://github.com/autowarefoundation/autoware.universe/blob/e337576f8a22a015df9a21f21e4beb12bbdae2b7/launch/tier4_control_launch/launch/control.launch.py
# In open-source project: autoware.universe
# Original file: Copyright (c) 2020 Tier IV, Inc.
...
def launch_setup(context, *args, **kwargs):
    ...
    controller_component = ComposableNode(
        ...
        remappings=[
            ...
            ("~/output/control_cmd", "control_cmd_reference"),
        ],
        parameters=[
            {
