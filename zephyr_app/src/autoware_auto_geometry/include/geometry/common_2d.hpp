// Based on: https://gitlab.com/autowarefoundation/autoware.auto/AutowareAuto/-/blob/e3e26be1ab4b822996df60f261d031d7924f20ac/src/common/autoware_auto_geometry/include/geometry/common_2d.hpp
// In open-source project: Autoware.Auto
// Original file: Copyright (c) 2017-2021, the Autoware Foundation
...
/// \return The x value of the point
/// \param[in] pt The point
inline auto x_(const autoware_auto_planning_msgs_msg_TrajectoryPoint & pt)
{
...
/// \return The y value of the point
/// \param[in] pt The point
inline auto y_(const autoware_auto_planning_msgs_msg_TrajectoryPoint & pt)
{
...
/// \return The z value of the point
/// \param[in] pt The point
inline auto z_(const autoware_auto_planning_msgs_msg_TrajectoryPoint & pt)
{
...
inline auto & xr_(autoware_auto_planning_msgs_msg_TrajectoryPoint & pt)
{
  return pt.pose.position.x;
}
...
/// \param[in] pt The TrajectoryPoint
inline auto & yr_(autoware_auto_planning_msgs_msg_TrajectoryPoint & pt)
{
  return pt.pose.position.y;
}
...
/// \param[in] pt The TrajectoryPoint
inline auto & zr_(autoware_auto_planning_msgs_msg_TrajectoryPoint & pt)
{
  return pt.pose.position.z;
}
}  // namespace point_adapter
