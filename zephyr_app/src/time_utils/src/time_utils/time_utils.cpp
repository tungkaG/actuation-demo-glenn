// Based on: https://gitlab.com/autowarefoundation/autoware.auto/AutowareAuto/-/blob/e3e26be1ab4b822996df60f261d031d7924f20ac/src/common/time_utils/src/time_utils/time_utils.cpp
...
////////////////////////////////////////////////////////////////////////////////
builtin_interfaces_msg_Time to_message(const std::chrono::system_clock::time_point t)
{
  const auto dt = t.time_since_epoch();
  return details::duration_to_msg<builtin_interfaces_msg_Time>(dt);
}

////////////////////////////////////////////////////////////////////////////////
builtin_interfaces_msg_Duration to_message(std::chrono::nanoseconds dt)
{
  return details::duration_to_msg<builtin_interfaces_msg_Duration>(dt);
}
